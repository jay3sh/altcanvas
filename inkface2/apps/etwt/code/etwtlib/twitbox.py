...
class TwitBox:
    ...
    def set_text(self, text):
        ...
        self.background_elem.refresh()

        self.text_elem.refresh(svg_reload=False)
    ...
    def get_bounding_box(self):
        ...
        bbox = (extents[0], extents[1], 
                extents[2]-extents[0], extents[3]-extents[1])
        return bbox
